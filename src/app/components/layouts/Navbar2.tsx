        ...
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex md:mx-auto order-2 md:order-1">
            <Popover className="z-10">
              <PopoverButton
                className="inline-flex items-center gap-x-1 text-sm font-medium"
              ...
              <PopoverPanel
                className={`absolute bg-gradient-to-r from-purple-400 to-red-400 text-white shadow-lg left-1/2 transform -translate-x-1/2 w-screen max-w-full mt-2 h-screen md:h-auto z-10 ${
                  ...
                  <div className="flex justify-between mx-auto">
                    <div className="flex flex-col md:flex-row justify-between w-full">
                            ...
                            <li key={key}>
                              <Popover className="relative">
                                ...
                                <PopoverPanel className="relative z-99 bg-white text-black p-4 mt-2 rounded shadow-lg">
                                  <ul className="space-y-1">
                                    {menuData[key as keyof typeof menuData].map(
                                      (item: {
                                        name?: string;
                                        title?: string;
                                        href: string;
                      ...
                      <div className="text-right md:hidden mt-4">
                        <button className="rounded-full mx-2 bg-purple-500 px-4 py-2">
                          Sign In
                        </button>
                        <button className="rounded-full mx-2 bg-purple-500 px-4 py-2">
                          Get started
          ...
          <div className="hidden md:flex md:flex-row mx-auto order-3">
            <Link
              className="rounded-full mx-2 bg-purple-500 px-4 py-2"
              href="/signin"
            >
              Sign In
            </Link>
